...
This project is indexed by GitNexus as **dotfiles** (40 symbols, 29 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
